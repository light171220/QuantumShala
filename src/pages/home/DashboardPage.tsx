...
export default function DashboardPage() {
  ...
  const currentStreak = userGameStats?.currentStreak || user?.currentStreak || 0
  const totalXp = userGameStats?.totalXp || user?.totalXp || 0
  const level = userGameStats?.level || user?.level || 1
