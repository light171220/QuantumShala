...
// Note: These interfaces are local since content is now loaded from S3/CDN
// This component is kept for potential future admin UI but the content
// management now happens via file system and S3 sync
